...
export const projectsData = [
  ...
  {
    _id: "69339e155104c93c052c9102", // ID generado siguiendo la secuencia
    title: {
      es: "BlogGen-ai – Generador de Contenido AI-Native",
      en: "BlogGen-ai – AI-Native Content Generator",
    },
    shortLabel: "bloggen-ai",
    description: {
      es: "Plataforma SaaS 'AI-Native' de alto rendimiento que transforma videos de YouTube en artículos de blog optimizados para SEO. Utiliza la LPU de Groq y el modelo Llama 3 para lograr tiempos de inferencia ultrarrápidos (<1.5s). El sistema integra un frontend en React 19 con TypeScript y un backend en Django 5, implementando autenticación segura (cookies HttpOnly), protección CSRF y un editor de Markdown en tiempo real. Destaca por el uso de 'System Prompt Engineering' para estructurar salidas complejas de IA y una arquitectura totalmente containerizada con Docker.",
      en: "High-performance 'AI-Native' SaaS platform that transforms YouTube videos into SEO-optimized blog articles. It leverages Groq's LPU and the Llama 3 model to achieve ultra-fast inference times (<1.5s). The system integrates a React 19 + TypeScript frontend with a Django 5 backend, implementing secure authentication (HttpOnly cookies), CSRF protection, and a real-time Markdown editor. It stands out for its use of 'System Prompt Engineering' to structure complex AI outputs and a fully containerized architecture using Docker.",
    },
    image: "/images/projects/bloggen-ai.webp", // Asegúrate de tener esta imagen o ajusta el nombre
    github: "https://github.com/JACS002/BlogGen-ai",
    demo: "", // Déjalo vacío si no está desplegado públicamente aún
    technologies: [
      "React",
      "TypeScript",
      "Django",
    ...
    createdAt: "2025-12-06T02:15:00.000Z",
  },
];
